                    ...
                    with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="add-student.php" class="nav-link active bg-light ">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <form action="add-student-db.php" method="POST" enctype="multipart/form-data">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <select name="grade" id="" class="form-control" required>
                                                            ...
                                                            <optgroup label="BACHELOR'S DEGREE">
                                                                ...
                                                                <option value="SECOND CLASS(UPPER DIVISION)">SECOND
                                                                    CLASS(UPPER DIVISION)</option>
                                                                <option value="SECOND CLASS(LOWER DIVISION)">SECOND
