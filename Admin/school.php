...
$school_info_query = "SELECT * FROM School_tbl WHERE id = 5";
                    ...
                    with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview ">
                                    ...
                                    <li class="nav-item">
                                        <a href="school.php" class="nav-link active bg-light">
                                ...
                                <ul class="nav nav-tabs nav-justified" id="custom-tabs-four-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-four-Manage-tab" data-toggle="pill"
                                            ...
                                            aria-controls="custom-tabs-four-messages" aria-selected="false">Update School Info</a>
                                    </li>
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-manage" role="tabpanel"
                                        aria-labelledby="custom-tabs-four-manage-tab">
                                            <form action="school-db.php" method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                            <div class="col-sm-12">
                                                            <div class="form-group has-success">
                                                        <label for="success" class="control-label heading">School Name</label>
                                                        <input type="text" name="update_school_name" class="form-control"
                                                             id="school_name" value="<?php  echo htmlspecialchars($display_school_name) ?>">
                                                        </div>
                                                            </div>
                                                            </div><!-- /row -->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <label for="success" class="control-label heading">Admin Login Site Logo</label>
                                                                    <img class="profile-user-img img-responsive rounded-0 mt-4  d-block"
                                                                    src="data:image/*;charset=utf8;base64,<?php echo ($display_login_picture); ?>"
                                                                    alt="profile picture" style="height:10em;width:10em;border:1px solid black">
                                                                <input type="file" name="limage" id="fileToUpload"
                                                                style="margin-top:7px;" >                                                            
                                                            </div>
                                                                <div class="col-sm-6">
                                                                    <label for="success" class="control-label heading">Verification Site Logo</label>
                                                                    <img class="profile-user-img img-responsive rounded-0 mt-4 d-block"
                                                                    src="data:image/*;charset=utf8;base64,<?php echo($display_verify_picture); ?>"
                                                                    alt="profile picture" style="height:10em;width:10em;border:1px solid black">
                                                                <input type="file" name="vimage" id="fileToUpload"
                                                                style="margin-top:7px;" >                                                            
                                                            </div>
                                                            </div>
                                                            <hr />
                                                <div class="">
                                                    <input type="submit" name="updatesubmit"value="Update" class="btn float-right">
                                                </div>
